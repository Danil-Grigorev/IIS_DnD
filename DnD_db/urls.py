...
urlpatterns = [
    ...
    path('new_session/<int:player_id>/', views.new_session, name='new_session_assigned'),
    path('new_character/', views.new_character, name='new_character'),
    path('new_character/<int:player_id>/', views.new_character, name='new_character_assigned'),
    ...
    path('character_details/<int:sess_id>/<int:char_id>/kill', views.kill_character, name='kill_character'),
    path('character_details/<int:sess_id>/<int:char_id>/revive', views.revive_character, name='revive_character'),
    path('character_details/<int:sess_id>/<int:char_id>/level_up', views.level_up, name='level_up'),
    path('character_details/<int:sess_id>/<int:char_id>/level_down', views.level_down, name='level_down'),
    path('character_details/<int:sess_id>/<int:char_id>/give_item', views.give_item, name='give_item'),
    path('character_details/<int:sess_id>/<int:char_id>/take_item', views.take_item, name='take_item'),
